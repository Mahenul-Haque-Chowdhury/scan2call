  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="visible">
      <motion.div variants={fadeUp}>
        ...
        <p className="mt-1 text-sm text-text-muted">Sign in to your Scan2Call account</p>
      </motion.div>
      ...
      <motion.div variants={fadeUp} className="mt-6">
        ...
        <Divider text="Or sign in with email" className="my-6" />
      </motion.div>
      ...
      <form onSubmit={handleSubmit}>
        <motion.div variants={stagger} initial="hidden" animate="visible" className="space-y-4">
          ...
          <motion.div variants={fadeUp} className="flex items-center justify-end">
            <Link href="/forgot-password" className="text-sm text-text-muted hover:text-primary transition-colors">
              Forgot password?
            </Link>
          </motion.div>
